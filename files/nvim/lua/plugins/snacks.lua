...
local keymaps = {
  ...
  { "<leader>notif", function() Snacks.picker.notifications() end,   desc = "Notification History" },
  ...
  { "<leader>fT", function() Snacks.terminal() end,                                       desc = "Terminal (cwd)",           mode = "n", },
  {
    ...
    function()
      Snacks.terminal(nil,
        { cwd = vim.fn.getcwd(), win = { position = "right", col = 2, row = 1, stack = true } })
    end,
  ...
  },
  {
    ...
    function()
      Snacks.terminal("copilot",
        { cwd = vim.fn.getcwd(), win = { position = "right", col = 2, row = 2, stack = true } })
    end,
    desc = "AI CLI",
    mode = "n",
  },
  ...
  { "<leader>notif", function() Snacks.notifier.show_history() end,                  desc = "Notification History" },
